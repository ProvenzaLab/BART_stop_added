  ...
  return new Promise((resolve) => {
    ...
    trials.forEach(trial => {
      ...
      timeline.push({
        ...
        choices: [],
        on_load: function () {
          const trialStartTime = getTimestamp();
    ...
    function saveCSV() {
      ...
      const header = "trialTimestamp,balloonType,outcome,reactionTime(ms),inflationTime(ms),total reward\n";
      const rows = trialData.map(trial => `${trial.timestamp},${trial.balloonType},${trial.outcome},${trial.reactionTime},${trial.inflationTime},${trial.reward}\n`);
